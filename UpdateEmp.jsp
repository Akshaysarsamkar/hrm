		...
		<div class="row flex-nowrap">
			...
			<div class="col py-3 bg-body-secondary">
				...
				<div class="border px-4 py-4 border-dark-subtle my-3 bg-light">
					<h1 class="text-center display-5 text-info">
						<i class="fa fa-edit" style="font-size: 48px"
							style="color:skyblue"></i> Edit Employee
					</h1>
					<form>
						<div class="mb-3">
						...
						<div class="mb-3">
							<label for="exampleInputNuban" class="form-label">Nuban</label> <input
								type="number" class="form-control" id="exampleInputNuban">
						</div>
						...
						<a type="button" class="btn btn-outline-success text-center"><i
							class="fa fa-cloud-upload"></i> Update Employee</a>
					</form>
				</div>
